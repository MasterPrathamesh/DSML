...
checkpoint_7200_path = '/content/drive/MyDrive/All_Checkpoints/checkpoint-7200'
model_paths = [
    '/content/drive/MyDrive/All_Checkpoints/Copy_of_coatnet_epoch_30.pth',
    '/content/drive/MyDrive/All_Checkpoints/Copy_of_ConvNeXt_model_epoch_29.pt',
    '/content/drive/MyDrive/All_Checkpoints/Copy_of_efficientformer_epoch_30.pth',
    '/content/drive/MyDrive/All_Checkpoints/Copy_of_swin_epoch_30.pth',
]
...
model_names = ["Swin", "CoAtNet", "ConvNeXt", "EfficientFormer", "Swin"]  # Adjusted names based on actual models
...
test_image_path = '/content/drive/MyDrive/cataract_2.jpg'
...
def predict():
    ...
    inputs_hf, img_pt = preprocess_image(img)
